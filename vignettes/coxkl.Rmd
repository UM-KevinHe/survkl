---
title: "survkl: Cox Models with KL Divergence for Survival Data Integration"
...
To address these issues, the `survkl` R package provides a transfer learning-based framework for efficient survival data integration, leveraging external information alongside newly collected time-to-event data.
...
This vignette provides an introduction to the `survkl` package and demonstrates its core functionalities.

## Installation:

You can install the development version of `survkl` from GitHub using remotes:
